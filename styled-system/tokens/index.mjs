const tokens = {
  ...
  "fonts.heading": {
    "value": "var(--font-valkyrie), sans-serif",
  ...
  "colors.background.accent": {
    "value": "#c2e5ff",
    "variable": "var(--colors-background-accent)"
  },
  "colors.background.accentAlt": {
    "value": "#f2d1f3",
    "variable": "var(--colors-background-accent-alt)"
  },
  "colors.background.callout": {
    "value": "#fffab8",
    "variable": "var(--colors-background-callout)"
  },
  "colors.text.primary": {
    "value": "#1d3e56",
  ...
  "colors.button.warning.background": {
    "value": "#e54d2e",
    "variable": "var(--colors-button-warning-background)"
  },
  "colors.button.warning.text": {
    "value": "#fffcfc",
    "variable": "var(--colors-button-warning-text)"
  },
  "colors.input.border.default": {
    "value": "#b9bbc6",
    "variable": "var(--colors-input-border-default)"
  },
  "colors.input.border.focus": {
    "value": "#0090ff",
    "variable": "var(--colors-input-border-focus)"
  },
  "colors.input.border.error": {
    "value": "#e54d2e",
    "variable": "var(--colors-input-border-error)"
  },
  "colors.divider.default": {
    "value": "#113264",
    "variable": "var(--colors-divider-default)"
  },
  "spacing.0": {
    "value": "0rem",
  ...
  "colors.colorPalette.callout": {
    "value": "var(--colors-color-palette-callout)",
    "variable": "var(--colors-color-palette-callout)"
  },
  ...
  "colors.colorPalette.warning.background": {
    "value": "var(--colors-color-palette-warning-background)",
    "variable": "var(--colors-color-palette-warning-background)"
  },
  "colors.colorPalette.warning.text": {
    "value": "var(--colors-color-palette-warning-text)",
    "variable": "var(--colors-color-palette-warning-text)"
  },
